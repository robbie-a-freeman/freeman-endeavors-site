...
const ROUTES: { path: string; titleContains: string }[] = [
	...
	{ path: '/case-studies/specialty-pharmacy-modernization/', titleContains: 'pharmacy' },
	{ path: '/case-studies/fintech-fractional-leadership/', titleContains: 'tech-lead seat' },
	{ path: '/case-studies/audit-to-modernization/', titleContains: 'audit' },

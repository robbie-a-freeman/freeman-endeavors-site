...
<svelte:head>
	<title>Shotgun B · Editorial Marginalia</title>
...
<section class="hero">
	<div class="grid">
		<div class="main">
			<p class="byline"><span class="glyph">§</span> A SOFTWARE CONSULTANCY</p>
			<h1 class="headline">
				We embed, we ship,<br />
		...
		<aside class="marginalia">
			<p class="margin-byline"><em>— Notes from the principal</em></p>
